 ...
 <span className="text-6xl md:text-6xl lg:text-7xl font-bold leading-snug " style={{
   ...
   display: 'inline-block'
      ...
      <motion.div
        ...
        transition={{duration: 1,}}>
        <p>
          🛠️ Built With: React Native, Django, CSS, PostgreSQL database, figma, managed tasks through Jira, and deployed using Heroku.
        </p>
      </motion.div>
...
const TestPage3 = (props) => {
  const images = [
    { image: mob1, text: "180dc's10th anniversary" },
