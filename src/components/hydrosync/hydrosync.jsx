  ...
  <div>
    ...
    <span className="text-6xl md:text-6xl lg:text-7xl font-bold leading-snug " style={{
      ...
      <span className="text-sm sm:text-base md:text-xl md:mt-0" style={{
        ...
        WebkitTextFillColor: 'transparent',
        display: 'inline'
      }}>MedHack 2024: A 48-hour hackathon driving innovation in aged-care.</span> </div>
      </div>
      ...
      <motion.div
        ...
        <p>⭐️ HydroSync provides a non-invasive hydration monitoring solution, allowing families to track their loved ones' hydration levels via our app. Our mission is to tackle elderly dehydration, a often ignored issue with profound health impacts.
      ...
      <motion.div
        ...
        transition={{duration: 1,}}>
        <p>
          🛠️ Built With: Python, React, TypeScript, Django, and CSS.
        </p>
      </motion.div>
