      ...
      <div style={{ marginBottom: '45px' }}>
        ...
        <div>
          <span className="text-sm sm:text-base md:text-xl md:mt-0" style={{
            ...
            WebkitTextFillColor: 'transparent',
            display: 'inline'
          }}>UniHack 2024: A 48-hour hackathon for web/mobile development.</span>
        </div>
      </div>
      <motion.div
        ...
        <p>⭐️ StorySearch uses AI to create engaging learning experiences through personalized picture books. We aim to combat the decline in children's attention spans, often attributed to short-form content.</p>
      </motion.div>
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 1 }}>
        <p>❓ How does it work? Utilizing OpenAI for content generation, StorySearch enables kids to explore a wide range of topics tailored to their specific interests. Each book contains unique images and text relevant to the chosen topic, fostering curiosity and creativity.</p>
      </motion.div>
      <motion.div
        className="text-sm sm:text-base md:text-lg pb-3 mt-1 pt-3"
        style={{ fontFamily: "'Sometype Mono', monospace", color: '#cccccc' }}
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 1 }}>
        <p>🛠️ Built With: Firebase, OpenAI, React, Python, and Tailwind CSS.</p>
      </motion.div>
    </div>
  );
};
